...
final List<Rutina> rutinas = [
  ...
  Rutina(
    ...
    descripcion:
        "Rutina natural para relajarte y mejorar el sueño.",
    ...
    consejo:
        "Mantén tu habitación fresca y oscura para mejorar el descanso.",
  ...
  Rutina(
    ...
    descripcion:
        "Plantas ideales para combatir fatiga y cansancio.",
    ...
    consejo:
        "Evita consumir estas plantas antes de dormir.",
  ...
  Rutina(
    ...
    descripcion:
        "Ayuda natural para gripe y congestión.",
  ...
  Rutina(
    ...
    descripcion:
        "Ayuda a aliviar molestias digestivas.",
    ...
    consejo:
        "Consumir lentamente para mejores resultados.",
