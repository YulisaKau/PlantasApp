...
final List<Planta> plantas = [
  ...
  contraindicaciones:
      "Evitar en personas alérgicas a flores tipo margarita.",
  ...
  preparacion:
      "Extraer gel y aplicar directamente.",
  ...
  preparacion:
      "Hervir hojas frescas y servir caliente.",
  ...
  contraindicaciones:
      "Evitar exceso en gastritis severa.",
  ...
  contraindicaciones:
      "Evitar consumo excesivo durante embarazo.",

  propiedades:
      "Relajante y calmante natural.",
...
Planta(
  ...
  preparacion:
      "Hervir hojas y utilizar el vapor o preparar infusión.",
  ...
  contraindicaciones:
      "Evitar exceso en niños pequeños.",

  propiedades:
      "Descongestionante y refrescante.",
...
Planta(
  ...
  preparacion:
      "Preparar en infusión y consumir antes de dormir.",
  ...
  frecuencia:
      "1 vez antes de dormir",

  contraindicaciones:
      "No combinar con medicamentos sedantes.",
...
Planta(
  ...
  preparacion:
      "Tomar caliente en infusión antes de dormir.",
...
Planta(
  ...
  preparacion:
      "Hervir ramas de canela en agua durante 10 minutos.",
  ...
  contraindicaciones:
      "Evitar exceso durante embarazo.",
...
Planta(
  ...
  preparacion:
      "Preparar en infusión con hojas frescas.",
  ...
  contraindicaciones:
      "Evitar exceso en personas con gastritis severa.",
...
Planta(
  ...
  contraindicaciones:
      "Evitar en hipertensión sin supervisión.",
...
Planta(
  ...
  descripcion:
      "El tomillo ayuda a aliviar tos y molestias respiratorias.",
...
Planta(
  ...
  preparacion:
      "Aplicar en crema o consumir en té.",
