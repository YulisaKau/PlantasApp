  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => favoritosProvider.toggleFavorito(planta),
            icon: Icon(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoCard(context, planta.descripcion),
                  const SizedBox(height: 25),

                  // Beneficios
                  _buildSectionTitle(context, 'Beneficios'),
                  const SizedBox(height: 12),
                  _buildBenefitItem('Ayuda al bienestar'),
                  _buildBenefitItem('Uso medicinal natural'),
                  _buildBenefitItem(planta.beneficios),
                  const SizedBox(height: 25),

                  // Preparación
                  _buildSectionTitle(context, 'Preparación'),
                  const SizedBox(height: 12),
                  _buildInfoCard(context, planta.preparacion),
